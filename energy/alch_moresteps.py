...
def run(epsilon_r):
        ...
        # Thoughts from Dr. Hart: step functions are scary. They would modify their step function to curve a bit. But our step function cuts off smoothly...
...
################################################################################
        ...
        # Collect data
        xtc_reporter = XTCReporter('prod.xtc', 100000)
