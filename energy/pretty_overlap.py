## copied from https://github.com/alchemistry/alchemlyb/blob/862343b7365114cef5aea82243715935f0af6e61/src/alchemlyb/visualisation/mbar_matrix.py#L17
...
array = np.loadtxt('overlap.txt')
matrix = np.matrix(array)
plot_mbar_overlap_matrix(matrix)